...
const ActionComponent = (props) => {
  ...
  const moreButton = (
    <Link key={props.movie?props.movie.id:id}  to={props.movie&&props.movie.media_type==="tv"?`/series/${props.movie?props.movie.id:id}`:`/movie/${props.movie?props.movie.id:id}`}>
